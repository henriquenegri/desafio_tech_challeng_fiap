            ...
            <td className="block px-4 pt-2 pb-4 text-left align-middle md:table-cell md:px-8 md:py-6 md:text-right">
              <div className="flex items-center gap-2 md:justify-end">
                {tx.attachment && (
                  <button
                    type="button"
                    className="hover:bg-input text-muted hover:text-brand rounded-lg p-2.5 transition-colors duration-300 cursor-pointer"
                    onClick={() => {
                ...
                <button
                  type="button"
                  className="hover:bg-input text-muted hover:text-foreground rounded-lg p-2.5 transition-colors duration-300 cursor-pointer"
                ...
                <button
                  type="button"
                  className="text-muted rounded-lg p-2.5 transition-colors duration-300 hover:bg-red-500/10 hover:text-red-500 cursor-pointer"
