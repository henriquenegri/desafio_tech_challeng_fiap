    ...
    <div className="w-full px-6 py-5 md:px-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="bg-input border-outline/55 text-foreground placeholder:text-muted/70 w-full rounded-xl border py-3 pr-4 pl-12 text-sm outline-none transition-all duration-300 focus:border-brand focus:ring-1 focus:ring-brand/30 md:text-base"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-input border-outline/55 text-foreground rounded-xl border px-3 py-3 text-sm font-semibold outline-none transition-colors duration-300 focus:border-brand"
            >
          ...
          >
            ...
            {activeFiltersCount > 0 && (
              <span className={`flex h-5 items-center justify-center rounded-full px-2 text-xs font-bold ${
                isExpanded ? "bg-background text-brand" : "bg-brand text-background"
              }`}>
                {activeFiltersCount}
              </span>
            )}
          ...
          {activeFiltersCount > 0 && (
            <button
              type="button"
              onClick={onClear}
              className="text-muted hover:text-alert border-outline/30 flex items-center justify-center gap-2 rounded-xl border bg-transparent p-3 text-sm font-bold transition-colors hover:border-alert/30"
      ...
      <div
        className={`overflow-hidden transition-all duration-300 ease-in-out ${
          isExpanded ? "max-h-[500px] opacity-100 mt-5" : "max-h-0 opacity-0 pointer-events-none"
        }`}
      >
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="bg-surface border-outline/40 text-foreground w-full rounded-xl border px-3.5 py-2.5 text-sm outline-none transition-colors duration-300 focus:border-brand"
              >
            ...
            <div className="flex flex-col gap-1.5 sm:col-span-1">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="bg-surface border-outline/40 text-foreground w-full rounded-xl border px-3.5 py-2 text-sm outline-none transition-colors duration-300 focus:border-brand"
            ...
            <div className="flex flex-col gap-1.5 sm:col-span-1">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  min="0"
                  step="any"
                  className="bg-surface border-outline/40 text-foreground placeholder:text-muted/50 w-full rounded-xl border px-3.5 py-2 text-sm outline-none transition-colors duration-300 focus:border-brand"
                />
                <span className="text-muted text-xs font-medium">to</span>
                <input
                  type="number"
